...
export const Projects = () => {
  return (
    ...
    >
      <motion.h2
        className="relative text-5xl font-extrabold text-yellow-400 dark:text-gray-200 font-mono tracking-wider text-center mb-12"
...
function Card({ project, index }) {
  return (
    <motion.div
      className="w-full max-w-lg rounded-3xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 shadow-lg relative transition-transform duration-500 hover:scale-105 hover:shadow-2xl"
      initial="offscreen"
    ...
    >
      ...
      >        <h2 className="text-3xl font-bold mb-4 text-gray-700 dark:text-cyan-400 text-center font-mono">
          {project.title}
        </h2>
        <p className="text-gray-600 font-mono dark:text-gray-300 mb-6 text-center leading-relaxed">
          {project.description}
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-4">
          {project.languages.map((language, i) => (
            <span
              key={i}
              className="px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-md dark:from-cyan-600 dark:to-blue-700"
            >
              {language}
            </span>
          ))}
