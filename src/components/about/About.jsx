...
export const About = () => {
  return (
    ...
    >
      <motion.div
        className="fixed w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-cyan-400 rounded-full opacity-20 filter blur-3xl mix-blend-lighten pointer-events-none"
        style={{
          top: "50vh",
          left: "50vw",
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        <picture>
          <source srcSet="pp@512.avif" type="image/avif" />
          <source srcSet="pp@512.webp" type="image/webp" />
          <img
            src="pp@512.webp"
            alt="Aymeric Trinh - Développeur Front-End passionné par les technologies web modernes"
            width="256"
            height="256"
            loading="eager"
            fetchPriority="high"
